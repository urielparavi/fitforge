    ...
    <section id="pricing" className="relative py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={`text-center mb-16 space-y-4 transition-all duration-[800ms] ease-out ${inView ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-[15px] scale-[0.98]'}`}>
          ...
          <h2 className="text-4xl md:text-5xl font-black">בחר את <span className="text-orange-400">החבילה</span> שלך</h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            תכניות גמישות שמתאימות לכל תקציב ומטרה
          </p>
        </div>

        <div className={`grid md:grid-cols-3 gap-8 max-w-6xl mx-auto transition-all duration-[800ms] ease-out delay-150 ${inView ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-[15px] scale-[0.98]'}`}>
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <div className="flex items-baseline justify-center gap-2 mb-2">
                  <span className="text-5xl font-black text-orange-400">{plan.price}</span>
