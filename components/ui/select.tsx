...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    dir="rtl"
    className={cn(
      "flex h-10 w-full items-center !bg-transparent justify-between rounded-md border border-input px-3 py-2 text-sm placeholder:text-muted-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/25 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
